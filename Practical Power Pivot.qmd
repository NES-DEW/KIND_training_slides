...
- then look in the table you set as the Table Name to find your measure: ![Table Name](src/images/clipboard-2005550216.png)
- now drag the measure to the `Values` field, and then populate `Rows` with `short_story_collection[Decade]` ![Pivot table with measure](src/images/clipboard-3383725040.png)
